...
urlpatterns = [
    ...
    path('admin/account-username/', views.update_username, name='update_username'),
    path('admin/account-password/', views.change_password, name='change_password'),
    path('admin/check-data', views.checkbox_data, name='checkbox_data'),
